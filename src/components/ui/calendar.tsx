...
function Calendar({
  ...
  captionLayout = "label",
  buttonVariant = "ghost",
  // Mặc định tiếng Việt: tên tháng / thứ hiện bằng tiếng Việt, tuần bắt đầu Thứ Hai.
  locale = vi,
  formatters,
  components,
  ...props
    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "cn-calendar-caption text-base"
            : "cn-calendar-caption-label flex items-center gap-1 rounded-(--cell-radius) text-base [&>svg]:size-3.5 [&>svg]:text-muted-foreground",
