...
| 3 | [plan-flow-can-doi-5-ngay.md](plan-flow-can-doi-5-ngay.md) | **Thiết kế flow cân đối 5 ngày** (xưởng Đông): mô hình dữ liệu, công thức, màn hình — đã code trong `src/features/CanDoi.tsx` + `BangCanDoi.tsx` |
