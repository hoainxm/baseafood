// ============================================================
// Tên file cũ: src/lib/canDoi.ts
// Tên tiếng Việt: Thuật toán & Công thức Cân đối kỳ 5 ngày
// Description: Balancing period calculation formulas and helper algorithms
// ============================================================
