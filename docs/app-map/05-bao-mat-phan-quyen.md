...
ttl_days: 90
<!-- updated: 2026-08-26 — thêm vai trò "vice-manager" (Phó quản đốc — ghi thành phẩm hằng ngày). Vào Role/ROLES ở types.ts + nav-access.ts (ALLOWED_NAV → DEPT_SAN_XUAT, HOME_BY_ROLE → wip) → thấy đúng nav bộ phận Sản xuất, trang chủ /wip. Lưu CSV cột roles, KHÔNG cần migration. Admin gán ở màn Người dùng (chip tự hiện vì render từ ROLES). -->
